						...
						if (myComp == null)
							{
								...
								var myCompName = "HLAECAM File Import " + currentdate.charAt(16) + currentdate.charAt(17) + ":"+ currentdate.charAt(19) + currentdate.charAt(20)+ ":"+ currentdate.charAt(22) + currentdate.charAt(23);
								// reads from projects
								...
								XZ.name = "XZ " + currentdate.charAt(16) + currentdate.charAt(17) + ":"+ currentdate.charAt(19) + currentdate.charAt(20)+ ":"+ currentdate.charAt(22) + currentdate.charAt(23);

								Y = myComp.layers.addNull();
								Y.threeDLayer = true;
								Y.property("Position").setValue([0,0,0]);
								Y.name = "Y " + currentdate.charAt(16) + currentdate.charAt(17) + ":"+ currentdate.charAt(19) + currentdate.charAt(20)+ ":"+ currentdate.charAt(22) + currentdate.charAt(23);
								myCamera.parent = XZ;
								XZ.parent = Y;
